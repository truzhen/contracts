...
func validApprovedPackArtifactHandoffAttestation() ApprovedPackArtifactHandoffAttestation {
	return ApprovedPackArtifactHandoffAttestation{
		...
		ArtifactSHA256: "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef", EvidenceRefs: []string{"receipt://03/approval-001", "receipt://03/source-001"},
